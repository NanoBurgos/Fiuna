/*  FILA H - TEMA 1. Elaborar un programa que:
    Lea dos ternas de números flotantes a1, b1, c1 y a2, b2, c2,
    verifique si cumplen las condiciones para que cada terna
    represente lados de un triángulo, en caso contrario, lo lea
    nuevamente, luego calcule e imprima las respectivas áreas de
    superficie y un mensaje indicando si uno de ellos es un
...
int verObtusangulo( float a, float b, float c );
int main()
...
// areaTriang(): calcula el area de superficie de un triangulo.
    ...
    if ( verObtusangulo( a1, b1, c1 ) || verObtusangulo( a2, b2, c2 ) )
       cout << "\n\n\tUno de los triángulos dados es obtusangulo";
    else
       cout << "\n\n\tNinguno de los triángulos dados es obtusangulo";
    cout << "\n\n";
    system( "pause" );
}
int valLados( float a, float b, float c )
