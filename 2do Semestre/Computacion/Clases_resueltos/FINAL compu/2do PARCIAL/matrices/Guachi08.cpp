/*8-Lea e imprima dos numeros enteros y positivos m y n, mayores que 2
 y menores o iguales que 20, carga la matriz mat de orden mxn con
  los dobles de los primeros mxn numeros primos y luego imprime mat*/
#include<iostream>
using namespace std;
int validar()
{float x;
