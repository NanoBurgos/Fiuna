/*6-Lea e imprima dos numeros enteros y positivos m y n, mayores que 2 
y menores o iguales que 20, carga la matriz de orden mxn con los mxn primeros numeros primos y luego imprime mat*/
#include<iostream>
using namespace std;
int validar()
{float x;
