/* Lea dos ternas de numeros enteros y positivos h0, m0, s0 y hf, mf, sf
que representan, respectivamente, la hora, minuotos y segundos inicial y final de un 
proceso realizado en el mismo dis. Verifique que ambas ternas son horas validas como 
indicaria un reloj que marca 24 horas, y, que la hora final es posterior a la
inicial, si no leer nuevamente, luego determine. Imprima cuanto duro el proceso, en horas
minutos y segundos */
