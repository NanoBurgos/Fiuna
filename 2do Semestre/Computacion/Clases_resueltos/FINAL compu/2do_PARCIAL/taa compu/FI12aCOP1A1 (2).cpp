/*  FILA A - TEMA 1. Elaborar un programa que:
    Lea dos ternas de números enteros positivos y1, f1, i1 e
    y2, f2, i2, que representan, respectivamente, distancias medidas
    en yardas, pies y pulgadas. Verifique que ambas son distancias
    válidas y que la primera distancia es mayor que la segunda,
    sabiendo que 1 yarda = 3 pies y 1 pie = 12 pulgadas. Luego
    determine e imprima la diferencia de dichas distancias expresando
    el resultado en yardas, pies y pulgadas. Imprima, además, esta
    diferencia en cm, sabiendo que 1 pulgada = 2,54 cm.*/
#include<iostream>
